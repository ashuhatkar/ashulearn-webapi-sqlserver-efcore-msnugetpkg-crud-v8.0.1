/*--****************************************************************************
  ...
  --****************************************************************************/
using System;
using Nfs.Web.Framework.Models;

namespace Nfs.Catalog.Service.Models.Customers
{
    /// <summary>
    /// Represents customer dto model
    /// </summary>
    public partial record CustomerModel : BaseNfsEntityModel
    {
        /// <summary>
